...
Your API code can be generated in your PiShock controls, copy paste this into the quotation marks
...
The "api_throttle_limit" in the config can be changed to increase the amount of requests sent at a time. Lowering this number will allow more requests to be sent, e.g. "api_throttle_limit" : 2, will allow the program to send one request every 2 seconds. This may impact CPU usage.
